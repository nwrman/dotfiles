...
# By nwrman <iam@nwrman.net>
#
# Last modified: Wed Jan 25 16:42:45 CST 2012
...
# Nwr!, Great!!, now this does't cause any troubles with winscp
# or scp or whatever!
[[ "$-" != *i* ]] && return
...
#Nwr: This way, commands issued in other screen sessions immediately appear in the history of the
#current screen session (well, you need to press Enter first to update the history).
...
alias du='du -sckh'       # Makes a more readable output.
alias df='df -kTh'
...
#-------------------------------------------------------------
alias ls='ls -hlF --color'  # add colors for filetype recognitionm and also show as list
